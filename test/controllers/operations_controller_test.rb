...
class OperationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post operations_url, params: { operation: { type: @operation.type, value: @operation.value } }
    end
  ...
  test "should update operation" do
    patch operation_url(@operation), params: { operation: { type: @operation.type, value: @operation.value } }
